...
describe('QueueService', () => {
	...
	it('has a length of one when one item has been pushed', () => {
		const items: Event[] = [
			{ type: 'join', data: {}, date: new Date(), otherParent: '', selfParent: '', signature: '', consensusReached: false , creator: 'creatorMock' }
		];
	...
	it('returns the first item that was pushed with pop', () => {
		const items: Event[] = [
			{ type: 'join', data: {}, date: new Date(), otherParent: '', selfParent: '', signature: '', consensusReached: false, creator: 'creatorMock' },
			{ type: 'state', data: {}, date: new Date(), otherParent: '', selfParent: '', signature: '', consensusReached: false, creator: 'creatorMock' },
			{ type: 'transaction', data: {}, date: new Date(), otherParent: '', selfParent: '', signature: '', consensusReached: false, creator: 'creatorMock' }
		];
